...
public class TestDumpReader_0_11_Fragments
{
	private static final ExportSchemaVersion EXPORT_VERSION = ExportSchemaVersion.V0_11;

	private static final String PAGE_INPUT = "/input-0.11-page.xml";

	private static final String REVISION_INPUT = "/input-0.11-revision.xml";
